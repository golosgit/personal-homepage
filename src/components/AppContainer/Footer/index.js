  ...
  return (
    <FooterWrapper>
      ...
      <Summarization footerText>
        I'd like to start working as Junior Frontend Developer. There are some samples above and I hope it can help in convincing you to contact me.
      </Summarization>
      <Socials href="https://github.com/golosgit/">
        <Github />
      </Socials>
      <Socials href="https://www.linkedin.com/in/grzegorzgolos/">
        <LinkedIN />
      </Socials>
    </FooterWrapper>
  );
